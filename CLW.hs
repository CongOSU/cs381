...
data Circuit = Cir Gates Links
                deriving Show
data Gates = Ga (Int,GateFn) Gates
           | NOop
		      deriving Show
data GateFn = And
            | Or
...
{-
adder = Cir (Ga (1, Xor) (Ga (2, And))) (FromTo (1,1) (2,1) (FromTo (1,2) (2,2))) 
-}

Adder :: Gates -> Links 
  adder = Cir (Ga (1, Xor) (Ga (2, And))
            (FromTo (1,1) (2,1) (FromTo (2,1) (2,2))
